...
export default function LekhaJokhaPrivacyPage() {
  return (
    <main className="bg-white min-h-screen">
      ...
      {/* Navbar Gradient Offset - EXACTLY like original */}
      ...
      <section className="mx-auto max-w-4xl px-6 pb-24">
        ...
        <div className="mt-12 space-y-10">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6">Account Information</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6">Subscription and Licensing Information</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6">Technical Information</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-900">2. User Documents and Content</h2>
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6">Local-First Storage</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-900">3. Backup and Restore</h2>
          ...
          <ul className="list-disc pl-6 space-y-1 text-slate-700">
            ...
            <li>On third-party cloud storage services chosen and controlled by the user</li>
          </ul>
          ...
          <h2 className="text-2xl font-bold text-slate-900">4. Camera Access</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-900">5. File, Photo, Audio and Video Access</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-900">6. Email Verification and Account Security</h2>
...
Payment credentials are processed directly by the payment provider under its own privacy and security policies.
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6">Payment Providers</h3>
          <p>For payment processing and subscription management.</p>
          <ul className="list-disc pl-6 space-y-1 text-slate-700">
            <li>Razorpay</li>
          </ul>

          <h3 className="text-xl font-semibold text-slate-800 mt-6">Email Service Providers</h3>
          <p>For OTP delivery, verification emails, and account-related communication.</p>

          <h3 className="text-xl font-semibold text-slate-800 mt-6">Infrastructure Providers</h3>
          <p>
            For hosting account, subscription, licensing, and application services.
          </p>

          <h3 className="text-xl font-semibold text-slate-800 mt-6">Legal Authorities</h3>
          <p>
            Where required by law, court order, regulation, or governmental request.
          </p>

          <h2 className="text-2xl font-bold text-slate-900">10. Data Storage and Security</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-900">11. Data Retention</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-900">12. User Rights</h2>
...
<p>User documents, images, videos, audio recordings, backups, and other locally stored content remain under the user's control and are not retained by Ribionic Solutions as part of normal application operations.</p>
          ...
          <p>
            ...
            <br />
            Email: support@ribionic.com
            <br />
            Website: https://ribionic.com
            <br />
